...
$(document).ready(function(){
	...
	$("html").niceScroll({
		...
		cursorcolor: "#161A26",
		cursorwidth: "17px",
		cursorborderradius: "10px 50% 10px 50%",
		cursorborder: "none",
		zindex: 10000,
...
checkScrollForParallax: debounce(function() {
	$('.parallax').each(function() {
		...
		if(isElementInViewport($elem)){
			...
			oVal = ((window_bottom - parent_top) / 2);
...
$(function() {
	...
	$('.form-inline.login a').click(function() {
		$('.form-inline.login').animate({'left': '-100%'}, 1000);
		$('.form-inline.register').animate({'left': '0'}, 1000);
	});
	$('.form-inline.register a').click(function() {
		$('.form-inline.register').animate({'left': '-100%'}, 1000);
		$('.form-inline.login').animate({'left': '0'}, 1000);
	});
	$('.navbar a.register').click(function() {
		$('.form-inline.login').animate({'left': '-100%'}, 1000);
		$('.form-inline.register').animate({'left': '0'}, 1000);
	});
	$('.navbar a.login').click(function() {
		$('.form-inline.register').animate({'left': '-100%'}, 1000);
		$('.form-inline.login').animate({'left': '0'}, 1000);
	});
});
